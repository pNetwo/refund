...
export function Confirm() {
  ...
  return (
    <div className="bg-gray-500 lg:w-lg rounded-xl flex flex-col items-center p-10 gap-6">
      ...
      <CircleCheckBig className="text-green-100" size={150} />
      ...
      <a
        href="/"
        className="w-full p-3 text-center bg-green-100 rounded-lg text-white hover:opacity-85 transition duration-300 ease-linear"
      >
        Nova solicitação
      </a>
    </div>
